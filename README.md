## 👋 안녕하세요. Spring 기반 백엔드 개발자를 목표로 성장 중인 박지성입니다.

기능 구현에 그치지 않고  
**왜 이런 구조를 선택했는지, 트래픽과 확장성을 고려하면 어떤 문제가 생길 수 있는지**를 고민하며 개발합니다.

REST API 설계, 데이터베이스 모델링,  
Docker 기반 환경 구성과 메시지 브로커를 활용한 구조까지 경험했습니다.
...
![GitHub](https://img.shields.io/badge/GitHub-Collaboration-181717?style=flat&logo=github)
